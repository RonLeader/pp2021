...
def set_inf_student():
    global i
    st_number = int(input("Enter number of student: "))
    st_number = input_domain(st_number, 1, 999999)
    # --------list-----------
...
def get_st_inf():
    ...
    for i in range(0, len(st_Name)):
        print("This is the information of " + st_Name[i] + ": ")
        print("student name is: " + st_Name[i])
        print("student id is: " + st_ID[i])
        print("student DoB is: " + st_DoB[i])
...
while choice != 0:
    ...
    if choice == 1:
        ...
        for i in range(0, len(st_Name)):
            if st_Name[i] == name:
                check_stop = True
                stcourse = int(input("How many course " + st_Name[i] + " is learning: "))
